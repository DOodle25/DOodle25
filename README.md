...
- ### **Code-Canvas** *(In Progress)*
  A dynamic, code-driven **whiteboard app** to facilitate real-time collaboration and brainstorming.

---

### 📫 **Connect with Me**
Let’s collaborate and create magic! Feel free to reach out to me at: dipen.cse21@itwacademy.org

- **GitHub**: [@DipenPatel](https://github.com/dipen)
- **LinkedIn**: [@DipenPatel](https://www.linkedin.com/in/dipen-patel-4654771b9/)
- **Leetcode**: [@DipenPatel](https://leetcode.com/dipenpatel/)
---
...
Feel free to explore the different projects and let's connect!
